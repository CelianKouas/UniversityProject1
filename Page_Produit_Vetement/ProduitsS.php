        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-special">Tous les skis nautiques</h2>
                    <h3 class="section-subheading text-muted">Vous trouverez ici tous les skis nautiques que nous proposons sur BeWet.</h3>

                    <?php
                    require "../calldb.php";

                    {$produits = $pdo->query("SELECT * FROM produits where type='skis'");}
...
echo"                                    </button>";
echo <<<FOO
                                      <form method="post" action="../Acceuil/ppiAS.php">

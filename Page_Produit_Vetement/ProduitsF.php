        ...
        <section class="page-section bg-light" style="background-color: white" id="portfolio">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-special">Tous les vêtements pour femmes</h2>
                    <h3 class="section-subheading text-muted">Vous trouverez ici tous les vêtements pour femmes que nous proposons sur BeWet.</h3>

                    <?php
                    require "../calldb.php";

                    {$produits = $pdo->query("SELECT * FROM produits where sexe='femmes'");}
...
echo"                                    </button>";
echo <<<FOO
                                      <form method="post" action="../Acceuil/ppiVF.php">

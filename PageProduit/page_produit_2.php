        ...
        <section class="page-section bg-light" style='background-color: white' id="portfolio">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-genial">Tout les articles</h2>
                    <h3 class="section-subheading text-petit">Vous trouverez ici tout les articles.</h3>
                </div>
<?php 
...
echo"                                    </button>";
echo <<<FOO
                                      <form method="post" action="page_produit_inter.php">
FOO;
echo <<<FOO

...
FOO;
        ...
        <form action="inscription_inter.php" method="post">
            <div class="form-icon">
                <span><i class="icon icon-user"></i></span>
            </div>
            <p style="color: red">Veuillez remplir tout les champs correctement.</p>
            ...
            <div class="form-group">
                <select class="form-control item" name="sexe">
                <option>Homme</option>
                <option>Femme</option>
                <option>Autre</option>
                </select>
            ...
            <div class="form-group">
                <a href="connexion.php" class="btn btn-block create-account">Se connecter</a>
            </div>
        </form>
        </div>

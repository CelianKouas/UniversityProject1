        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-special">Toutes les planches à voile</h2>
                    <h3 class="section-subheading text-muted">Vous trouverez ici toutes les planches à voile que nous proposons sur BeWet.</h3>

                    <?php
                    require "../calldb.php";

                    {$produits = $pdo->query("SELECT * FROM produits where nom_complet='Planche à Voile'");}
...
echo"                                    </button>";
echo <<<FOO
                                      <form method="post" action="../Acceuil/ppiAPV.php">

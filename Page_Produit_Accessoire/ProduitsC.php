        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-special">Tous les Canoë / Kayaks</h2>
                    <h3 class="section-subheading text-muted">Vous trouverez ici tous les canoës et kayaks que nous proposons sur BeWet.</h3>

                    <?php
                    require "../calldb.php";

                    {$produits = $pdo->query("SELECT * FROM produits where type='kayaks'");}
...
echo"                                    </button>";
echo <<<FOO
                                      <form method="post" action="../Acceuil/ppiAC.php">
